    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="content__header">
                Все авторы
                <a href="{{ route('authors.create') }}" class="butt add-button">
                    Добавить
                </a>
            </div>
            <div class="row">
                        ...
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td class="actions-buttons">
                                    <a href="{{ route('authors.edit', $item->author_id) }}" class="butt edit-button" title="Редактировать">
                                    ...
                                    <button onclick="remove('authors', {{ $item->author_id }})" class="butt del-button" title="Удалить">
